// Script standalone: pagina PromoOpcion, normaliza y guarda catalog.json en Vercel Blob.
// Corre desde GitHub Actions — sin req/res, solo process.env y process.exit.
